...
var I18N_STRINGS = {
  ...
  es: {
    ...
    ach_2_name:'En Racha',         ach_2_desc:'3 aciertos seguidos',
    ach_3_name:'Imparable',        ach_3_desc:'5 aciertos seguidos',
    ach_4_name:'Legendario',       ach_4_desc:'10 aciertos seguidos',
    ...
    ach_11_name:'Jugador',         ach_11_desc:'5 partidas jugadas',
    ach_12_name:'Explorador',      ach_12_desc:'Jugar los 3 modos principales',
    ...
    lb_subtitle: 'Reto del Día',
    lb_loading: 'Cargando ranking...',
    lb_empty: 'Nadie ha jugado aún hoy. ¡Sé el primero!',
    lb_empty_past: 'No hay datos de este día.',
    lb_error: 'No se pudo cargar el ranking.',
    lb_you: 'Tú',
    lb_participants: 'jugadores',
    lb_share: 'Compartir',
    lb_swipe_hint: '← desliza para cambiar de día →',
    /* ★ v5 — notificaciones ★ */
    settings_notif_on:   'Recordatorio diario',
    settings_notif_time: 'Hora del recordatorio',
  ...
  en: {
    ...
    lb_title: 'Daily Ranking',
    lb_subtitle: 'Daily Challenge',
    lb_loading: 'Loading ranking...',
    lb_empty: 'No one has played today yet. Be the first!',
    lb_empty_past: 'No data for this day.',
    lb_error: 'Could not load ranking.',
    lb_you: 'You',
    lb_participants: 'players',
    lb_share: 'Share',
    lb_swipe_hint: '← swipe to change day →',
    /* ★ v5 — notifications ★ */
    settings_notif_on:   'Daily reminder',
